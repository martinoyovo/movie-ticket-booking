        ...
        child: ElevatedButton(
          child: Row(
            ...
            children: const [
              ...
              Gap(10),
              Text('Beli Ticket', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),)
            ],
          ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(Styles.imagePath('star_wars.png'))
                      ),
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Star Wars :\nThe Last Jedi', style: TextStyle(fontSize: 22, color: Colors.white, letterSpacing: 1, fontWeight: FontWeight.bold),),
                            const Gap(15),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Spacer(),
                            const Text('8.9/10', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17),)
                          ],
                        ),
                      ),
                      Container(
                        ...
                        child: Column(
                          children: [
                            Text('Duration', style: TextStyle(color: Colors.white.withOpacity(0.35), fontSize: 12)),
                            const Spacer(),
                            const Text('152 Min', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17),)
                          ],
                        ),
                      ),
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Spacer(),
                            const Text('13+', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17),)
                          ],
                        ),
                      ),
                    ],
...
Star Wars: The Last Jedi ditulis & disutradarai oleh Rian Johnson dan diproduseri Kathleen Kennedy serta Ram Bergman. J.J. Abrams, Tom Karnowski dan Jason McGatlin sebagai produser eksekutif.""", style: TextStyle(fontSize: 12, color: Colors.white.withOpacity(0.4), letterSpacing: 1, fontWeight: FontWeight.w400),)
                ],
              ),
            )
          ],
